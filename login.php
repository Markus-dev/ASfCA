...
?>  
    ...
    <p>Ты уже вошёл</p>
    <meta http-equiv="refresh" content="1;URL=http://frogling.com/frogid/iindex.php" />
     <?php  
}    
...
{  
    ...
    {  
        echo "<h1>Ошибка</h1>";  
        echo "<p>Прости, но мы не нашли такого аккаунта. Можешь <a href=\"login.php\">попробовать ещё раз</a>.</p>";  
    } 
}  
else  
{  
